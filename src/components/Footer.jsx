...
const Footer = () => {
  return (
    <footer className="footer footer-center p-10 bg-green-500 text-primary-content mt-5 rounded-md">
  <aside>
    ...
    <p className="font-bold">
      Travel America Ltd. <br/>Providing reliable Service since 1992
    </p> 
    <p>Copyright © 2024 - All right reserved</p>
    <h2 className="mt-3 text-3xl">Contact Us</h2>
    <h3 className="text-2xl">+9884848232</h3>
  </aside> 
  <nav>
